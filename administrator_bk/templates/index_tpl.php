...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Devetloper by Bùi Văn Nghị'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Powered by <a><span style="color:#f00;">Thiết kế website Bùi Văn Nghị</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:buivannghi1991@gmail.com">buivannghi1991@gmail.com</a></strong></p>

  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="tb_data_small">Images</td>
        <td class="tb_data_small">Số lượng</td>
        <td class="tb_data_small">Tiêu biểu</td>
        <td class="tb_data_small">Sp hot</td>
    ...
    <tbody>
       ...
       <td>
        ...
        <td align="center"><img src="<?=_upload_product.$items[$i]['thumb']?>" height="45"></td>
        <td align="center"><?=$items[$i]['soluong']?></td>
        <td align="center">
        ...
        <td align="center">
          <a data-val2="table_<?=$_GET['com']?>" rel="<?=$items[$i]['banchay']?>" data-val3="banchay" title class="status smallButton tipS" original-title="<?php if($items[$i]['banchay']==0) echo 'Click để hiện'; else echo "Click để ẩn"; ?>" data-val0="<?=$items[$i]['id']?>" >

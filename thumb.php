...
define ('CACHE_MAX_AGE', 8640000);			// time to cache in the browser
define ('VERSION', '1.30');					// version number (to force a cache refresh)
define ('DIRECTORY_CACHE', './cache');		// cache directory
define ('MAX_WIDTH', 15000);					// maximum image width
define ('MAX_HEIGHT', 15000);				// maximum image height
define ('ALLOW_EXTERNAL', FALSE);			// allow external website (override security precaution - not advised!)
define ('MEMORY_LIMIT', '100M');				// set PHP memory limit
define ('MAX_FILE_SIZE', 150000000);			// file size limit to prevent possible DOS attacks (roughly 1.5 megabytes)
